...
public class GetEntrustListTest extends BaseTest {
    ...
    public void getEntrustListTest(int current, String tradeMappingId, String state, int orderMode) {
        ...
        Assert.assertEquals(userId, USERID_SELL, "用户编号不是预期值！");
    }
    ...
    public void getEntrustDetailListTest() {
        ...
        Assert.assertEquals(msg, "Success", "接口请求不成功！");
    }
    ...
    @Test(dependsOnMethods = "queryMarketTradeTest")
     ...
     * 查询用户信息
     */
    @Test(dependsOnMethods = "queryMarketTradeMappingTest")
